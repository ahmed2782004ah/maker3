...
async def welcome(client: Client, message):
   try:
    ...
    if message.new_chat_members[0].username == "E_Z_9":
      try:
         ...
         await client.set_administrator_title(chat_id, user_id, "شادو")
      except:
        pass
      return await message.reply_text(f"**انضم المطور شادو للشات .\nمرحبا بك : @E_Z_9 .**")
