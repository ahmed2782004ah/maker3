...
from SEMO.Data import (get_dev, get_groupsr, get_channelsr, get_dev_user)
...
async def alive(client: Client, message):
    ...
    alive = f"""╭──── • ◈ • ────╮
么 [𝑫𝒆𝒗 𝒔𝒐𝒖𝒓𝒄𝒆](https://t.me/E_Z_9).
么 [𝑪𝒉𝒂𝒏𝒏𝒆𝒍 𝒔𝒐𝒖𝒓𝒄𝒆](BE_XB).
么 [𝑮𝒓𝒐𝒖𝒑 𝒔𝒐𝒖𝒓𝒄𝒆](https://t.me/+gd7IDYDFObU5NzE8).
╰──── • ◈ • ────╯
🚦𝑻𝒉𝒆 𝒃𝒆𝒔𝒕 𝒔𝒐𝒖𝒓𝒄𝒆 𝒕𝒆𝒍𝒆𝒈𝒓𝒂𝒎 ."""

    await message.reply_photo(
        photo=f"https://telegra.ph/file/fa5a2ef2f3d5b516a7499.mp4",
        caption=alive,
        reply_markup=keyboard,
    )

@Client.on_message(filters.command(["المطور شادو","شادو","المبرمج"], ""))
async def deev(client: Client, message: Message):
     if await joinch(message):
            return
     user = await client.get_chat(chat_id="E_Z_9")
