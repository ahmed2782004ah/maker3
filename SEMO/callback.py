...
[InlineKeyboardButton("صاحب السورس 🧑‍✈️", url=f"https://t.me/E_Z_9")],
[InlineKeyboardButton("طريقة التشغيل 🧠", callback_data="bcmds"),InlineKeyboardButton("طريقة التفعيل 🦸", callback_data="bhowtouse")],
[InlineKeyboardButton("جروب البوت 🤖", url=f"https://t.me/+gd7IDYDFObU5NzE8"),InlineKeyboardButton("قناه التحديثات 🐉", url=f"https://t.me/BE_XB")],
...
ᴘᴏᴡᴇʀᴇᴅ ʙʏ [{OWNER_NAME}]""",
        ...
        reply_markup=InlineKeyboardMarkup([
[InlineKeyboardButton("The owner of the SEMO 🧑‍✈️", url=f"https://t.me/E_Z_9")],
...
[InlineKeyboardButton("Bot Group 🤖", url=f"https://t.me/+gd7IDYDFObU5NzE8"),InlineKeyboardButton("Channel Updates 🐉", url=f"https://t.me/BE_XB")],
[InlineKeyboardButton(f"{devname}", user_id=f"{dev}")],
